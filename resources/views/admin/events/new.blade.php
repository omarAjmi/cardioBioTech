                                ...
                                <form action="{{ route('admin.createEvent') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input id="title" name="title" placeholder="titre" class="form-control" type="text">
                                            @if ($errors->has('title'))
                                                <small class="form-text text-muted status--denied"> Titre officiel d'événement</small>
                                            @else
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input id="abbreviation" name="abbreviation" placeholder="abbreviation" class="form-control" type="text">
                                            @if ($errors->has('abbreviation'))
                                            <small class="form-text text-muted status--denied"> Abbreviation d'événement</small>
                                            @else
                                    ...
                                    <div class="row form-group">
                                        <div class="col-4">
                                            <input name="state" placeholder="Governorat" class="form-control" type="text">
                                        </div>
                                        <div class="col-4">
                                            <input name="city" placeholder="Ville" class="form-control" type="text">
                                        </div>
                                        <div class="col-4">
                                            <input name="street" placeholder="Rue" class="form-control" type="text">
                                        </div>
                                    </div>
                                    <div class="row form-group">
