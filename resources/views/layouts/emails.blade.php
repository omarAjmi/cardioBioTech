<html>
    <head>
        <title>Fashionable a Fashion Category Email Template | w3layouts</title>
        <!-- Custom Theme files -->
                ...
                <table width="620" border="0" cellspacing="0" cellpadding="0" align="center" class="scale">
                    <tbody><tr>
                        <td bgcolor="#FFFFFF" style="border-top-left-radius: 4px; border-top-right-radius: 4px;">
                            ...
                            <table width="540" border="0" cellspacing="0" cellpadding="0" align="center" class="scale">
                                <tbody><tr><td class="w3l-4h" height="84">&nbsp;</td></tr>
                                </tbody></table>
                ...
                <table width="620" border="0" cellspacing="0" cellpadding="0" align="center" class="scale">
                    <tbody><tr>
                        <td bgcolor="#FFFFFF" style="border-bottom-left-radius: 4px; border-bottom-right-radius: 4px;">
                            ...
                            <table width="540" border="0" cellspacing="0" cellpadding="0" align="center" class="scale">
                                <tbody><tr><td class="w3-gr" height="84">&nbsp;</td></tr>
                                </tbody></table>
                    ...
                    <tbody><tr>
                        <td>
                            ...
                            <table width="540" border="0" cellspacing="0" cellpadding="0" align="center" class="smocale">
                                <tbody><tr><td class="mo" height="54">&nbsp;</td></tr>
                                <tr>
                                    <td align="center">
                                ...
                                <tr>
                                    <td align="center" style="font-family:'Candara', sans-serif; color: #fefefe; font-size: 15px;" class="scale-center-both">
                                        © <script> document.write(new Date().getFullYear());</script> <a href="{{ route('welcome') }}">{{ env('APP_NAME') }}</a>. Tous droits reservés
                                    </td>
                                </tr>
